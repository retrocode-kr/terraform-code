...
variable "create_sg" {
  description = "check create security group"
  type        = bool
  default     = false
}
...
/*
variable "ingress_allow_subnet_logic" {
  description = "ingress subnet logic"
  type = string
...
variable "egress_allow_subnet_logic" {
  description = "egress subnet logic"
  type = string
}

variable "ingress_information" {
  description = "input information of ingress"
  type = map(any)
}
*/
