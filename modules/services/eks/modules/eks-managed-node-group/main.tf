...
locals {
  launch_template_name = coalesce(var.launch_template_name, "${var.name}-eks-node_group")
    ...
    content {
      ...
      dynamic "ebs" {
        ...
        content {
          ...
          kms_key_id            = try(ebs.value.iops, null)
          snapshot_id           = try(ebs.vaule.snapshot_id, null)
 ...
 dynamic "placement" {
  ...
  dynamic "private_dns_name_options" {
    ...
    content {
      ...
      enable_resource_name_dns_a_record    = try(private_dns_name_options.value.hostname_type, null)
      hostname_type = try(private_dns_name_options.value.hosstname_type, null)
    }
  }
